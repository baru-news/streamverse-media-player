...
    // Pastikan pengguna sudah login sebelum melakukan sharing
    if (!user) {
      toast({
        title: "Login Diperlukan",
...
        });
        
        // PERBAIKAN: Panggil updateTaskProgress setelah share berhasil
...
        });
      } catch (error) {
        // Tangani kasus user membatalkan share
...
      }
    } else {
      // Fallback: Salin link dan perbarui progres
      handleCopyLink(shareUrl);
      
