...
-- First remove defaults from columns
ALTER TABLE videos ALTER COLUMN provider DROP DEFAULT;
ALTER TABLE videos ALTER COLUMN primary_provider DROP DEFAULT;
...
ALTER TABLE videos ALTER COLUMN provider SET DEFAULT 'doodstream'::video_provider;
ALTER TABLE videos ALTER COLUMN primary_provider SET DEFAULT 'doodstream'::video_provider;
